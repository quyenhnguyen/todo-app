...
app.post('/users', (req, res) => {
    db_model.createUserAccount(req.body)
    .then(response => {
      res.status(200).send(response);
    })
    .catch(error => {
...
app.get('/users/:id/tasks', (req, res) => {
    ...
    db_model.getUserTodo(req.params.id)
    .then(response => {
        res.status(200).send(response);
    })
    .catch(error => {
...
app.post('/tasks', (req, res) => {
    db_model.createUserTodo(req.body)
    .then(response => {
        res.status(200).send(response);
    })
    .catch(error => {
...
app.delete('/tasks/:task_id', (req, res) => {
    db_model.deleteUserTodo(req.params.task_id)
    .then(response => {
        res.status(200).send(response);
    })
    .catch(error => {
